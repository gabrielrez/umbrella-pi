...
<header id="home" class="text-black md:fixed md:w-full md:top-0 md:right-0 md:left-0">
  <div class="mx-auto container p-5 mt-4 md:flex items-center justify-between hidden bg-white/60 backdrop-blur-md rounded-lg">
...
<main data-anima="show-up" class="mt-20 max-w-screen-xl m-auto p-5 grid md:grid-cols-2 grid-cols-1 gap-10 mt-16 md:text-start">
